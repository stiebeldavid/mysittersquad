...
export const fetchRequests = async (parentRequestorMobile: string) => {
  ...
  try {
    ...
    return records.map((record) => ({
      ...
      babysitterName: record.get('Babysitter Name (from Babysitter)') as string,
      firstName: record.get('First Name (from Babysitter)') as string,
      lastName: record.get('Last Name (from Babysitter)') as string,
